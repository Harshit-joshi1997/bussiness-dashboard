...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex w-full bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 transition-colors">
      ...
      {/* Form Side */}
      <div className="flex-1 flex flex-col items-center justify-center p-8 sm:p-12 h-screen overflow-y-auto">
        <motion.div
        ...
        >
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full py-3 px-4 mt-6 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium flex items-center justify-center gap-2 transition-colors"
            >
              Create Account
              <ArrowRight size={20} />
            </motion.button>

            <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-6 pb-6">
